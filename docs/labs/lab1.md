...
| 項目 | 例 | 用途 |
|---|---|---|
| ゲートウェイ URL | `https://apim-aigw-handson-<id>.azure-api.net` | Lab 3 で curl 実行先 |
| 構成 URL | `apim-aigw-handson-<id>.configuration.azure-api.net` | Lab 5 SHGW で使用 |
